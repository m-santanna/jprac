 ...
 * @param KICK Event triggered by the client, where the owner pressed to kick a specific user.
 ...
 * @param YOU_WERE_KICKED Event sent from the server to the client, informing them that they were kicked by the lobby owner.
 ...
 * @param PLAYER_KICKED Event sent from the server to the clients subscribed in the specific lobby, informing a player was kicked by the lobby owner.
 ...
 * @param FINISHED Event sent from the server to the client, informing the player is done with the game.
 * @param ANOTHER_PLAYER_FINISHED Event sent from the server to the clients subscribed in the specific lobby, informing another player finished the game.
 */
export const events = {
  ...
  FINISHED: "FINISHED",
  ANOTHER_PLAYER_FINISHED: "ANOTHER_PLAYER_FINISHED",
}
